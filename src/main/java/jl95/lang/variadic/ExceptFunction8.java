...
/**
 * An interface for a function that takes 8 arguments. <br/>
 ...
 */
public interface ExceptFunction8<R, E extends Exception, A1, A2, A3, A4, A5, A6, A7, A8> {
     ...
     */
    public R apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8) throws E;
    /**
     * interface method
     * @param a1 argument nr 1
     * @param a2 argument nr 2
     ...
     * @throws E generic error
     */
    default public R call(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8) throws E { return apply(a1,a2,a3,a4,a5,a6,a7,a8);}
}