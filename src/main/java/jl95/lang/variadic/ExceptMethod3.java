 ...
 */
public interface ExceptMethod3<E extends Exception, A1, A2, A3> {
     ...
     */
    public void accept(A1 a1, A2 a2, A3 a3) throws E;
    /**
     * interface method
     ...
     * @throws E generic error
     */
    default public void call(A1 a1, A2 a2, A3 a3) throws E {accept(a1,a2,a3);}
}