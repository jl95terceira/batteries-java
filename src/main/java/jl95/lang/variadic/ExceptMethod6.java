 ...
 */
public interface ExceptMethod6<E extends Exception, A1, A2, A3, A4, A5, A6> {
     ...
     */
    public void accept(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6) throws E;
    /**
     * interface method
     ...
     * @throws E generic error
     */
    default public void call(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6) throws E {accept(a1,a2,a3,a4,a5,a6);}
}