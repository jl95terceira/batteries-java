...
/**
 * An interface for a method (a function that returns {@code void}) that takes 8 arguments. <br/>
 ...
 */
public interface ExceptMethod8<E extends Exception, A1, A2, A3, A4, A5, A6, A7, A8> {
     ...
     */
    public void accept(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8) throws E;
    /**
     * interface method
     ...
     * @throws E generic error
     */
    default public void call(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8) throws E {accept(a1,a2,a3,a4,a5,a6,a7,a8);}
}