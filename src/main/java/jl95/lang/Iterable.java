...
public interface Iterable<T> extends java.lang.Iterable<T> {
     ...
     */
    public static <T> Iterable<T> of(java.lang.Iterable<T> xx) {
        return () -> xx.iterator();
    }
     ...
     * @param <T> type of elements
     */
    public static <T> Iterable<T> ofArray(T[] xx) {
     ...
     * @return any true
     */
    public static Boolean any(java.lang.Iterable<Boolean> xx) {

        return Iterable.of(xx).any(x -> x);
    }
     ...
     * @return all true
     */
    public static Boolean all(java.lang.Iterable<Boolean> xx) {

        return Iterable.of(xx).all(x -> x);
    }
     ...
     */
    public static <T> Iterable<T> flat(java.lang.Iterable<T>... xx) {
     ...
     */
    public static <K, V> Map<K, ? extends Set<V>> group(Function1<K, V> f, Set<V> vv) {

        return Iterable.of(vv).apply(new HashMap<>(), (v, map) -> {

            K k = f.call(v);
            Set<V> groupvv = map.containsKey(k) ? (map.get(k)) : function(() -> {
     ...
     */
    public static <K, V> Map<K, ? extends List<V>> group(Function1<K, V> f, java.lang.Iterable<V> vv) {

        return Iterable.of(vv).apply(new HashMap<>(), (v, map) -> {

            K k = f.call(v);
            List<V> groupvv = map.containsKey(k) ? (map.get(k)) : function(() -> {
     ...
     */
    public static <T> Iterable<List<T>> zip(java.lang.Iterable<T>... xx) {

        return () -> new Iterator<List<T>>() {

            private final Iterable<Iterator<T>> itt = Iterable.of(I(xx).map(x -> x.iterator()).toList());
            private final Iterable<Boolean> itthasNext = itt.map(it -> it.hasNext());
            private final Iterable<T> ittnext = itt.map(it -> it.next());

            @Override
            public boolean hasNext() {
                return Iterable.all(itthasNext);
            }

            @Override
            public List<T> next() {
                return ittnext.toList();
            }
        };
    }
     ...
     */
    public static <A, B> Iterable<Tuple2<A, B>> zip(java.lang.Iterable<A> aa, java.lang.Iterable<B> bb) {
        ...
        return () -> new Iterator<Tuple2<A, B>>() {
            ...
            @Override
            public boolean hasNext() {
                return aait.hasNext() && bbit.hasNext();
            }

            @Override
            public Tuple2<A, B> next() {
                return tuple(aait.next(), bbit.next());
            }
        };
    }
     ...
     */
    public static <T> Iterable<T> repeat(T v, Integer n) {
     ...
     */
    public static <T> Iterable<T> repeat(T v) {
    ...
    public static <T> Iterable<T> cycle(Iterable<T> xx) {

        return () -> new Iterator<>() {

            List<T> xxList = Iterable.of(xx).toList();
     ...
     */
    public default <U> Iterable<U> map(Function1<U, T> f) {
     ...
     */
    public default Iterable<Tuple2<Integer, T>> enumerate(Integer i0) {

        return () -> new Iterator<Tuple2<Integer, T>>() {

            private final Iterator<T> it = Iterable.this.iterator();
     ...
     * @return enumerated values
     */
    public default Iterable<Tuple2<Integer, T>> enumerate() {
        return enumerate(0);
    }
     ...
     */
    public default <U> U reduce(U i, Function2<U, U, T> f) {
     ...
     * @return reduced iterable as value
     */
    public default <U> U reduce(U i, Method2<U, T> f) {
     ...
     */
    public default Iterable<T> filter(Function1<Boolean, T> f) {
     ...
     */
    public default <U> U apply(U i, Method2<T, U> f) {
     ...
     */
    public default Iterable<T> peek(Method1<T> f) {
     ...
     * @return evaluation
     */
    public default Boolean any(Function1<Boolean, T> f) {
     ...
     * @return evaluation
     */
    public default Boolean all(Function1<Boolean, T> f) {
     ...
     */
    public default <U> Iterable<U> flatmap(Function1<java.lang.Iterable<U>, T> f) {
    ...
    public default Iterable<T> cycle() {
        return cycle(this);
    }
     ...
     * @return list
     */
    public default <L extends StrictList<T>> L to(L i) {
     ...
     * @return map
     */
    public default <K, V, M extends Map<K, V>> M to(M i, Function1<K, T> k, Function1<V, T> v) {
     ...
     * @return map
     */
    public default <K, V, M extends StrictMap<K, V>> M to(M i, Function1<K, T> k, Function1<V, T> v) {
     ...
     * @return map
     */
    public default <K, V> HashMap<K, V> toMap(Function1<K, T> k, Function1<V, T> v) {
     ...
     */
    @Deprecated
    public default ArrayList<T> List() {
        return toList();
    }
     ...
     */
    @Deprecated
    public default <U> ArrayList<U> List(Function1<U, T> f) {
        return toList(f);
    }
     ...
     */
    @Deprecated
    public default <K, V> HashMap<K, V> Map(Function1<K, T> k, Function1<V, T> v) {
        return toMap(k, v);
    }
     ...
     */
    @Deprecated
    public default <K> HashMap<K, T> Map(Function1<K, T> k) {
        return toMap(k);
    }
}
